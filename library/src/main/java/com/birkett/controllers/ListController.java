...
public class ListController extends ViewController {
    ...
    private void ensureList() {
        ...
        if (root instanceof ListView) {
            ...
            /// TODO can we live without this? mProgressContainer = root.findViewById(android.R.id.progressContainer);
            /// TODO can we live wihtout this? mListContainer = root.findViewById(android.R.id.listContainer);
